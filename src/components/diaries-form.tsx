...
export default function DiaryForm({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <form
        action={action}
        className="relative z-50 w-[90%] max-w-lg bg-white shadow-2xl rounded-xl p-6 space-y-6 animate-fadeIn"
      >
        ...
        <div className="flex flex-col">
          <label htmlFor="title" className="mb-2 text-gray-700 font-medium">
            Title
          </label>
          <input
            type="text"
          ...
          />
          {state?.errors?.title && (
            <p className="text-red-500 mt-1 text-sm">{state.errors.title}</p>
          )}
        </div>

        <div className="flex flex-col">
          <label htmlFor="content" className="mb-2 text-gray-700 font-medium">
            Content
          </label>
          <textarea
            name="content"
